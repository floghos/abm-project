...
;; maybe would work better as a reporter
to remove-agent [ _id ]
...
Este es un sub-modelo de Containment of Epidemic Desease. La documentación de como funciona se encuentra en la info de este.
@#$#@#$#@
default
true
0
